...
function ChessBlock({ block, updateBlock, removeBlock }: { block: Block, updateBlock: any, removeBlock: any }) {
 ...
 <button onCliSck={handlePrev} disabled={currentMove === 0} className="w-10 h-10 flex items-center justify-center bg-slate-100 hover:bg-slate-200 rounded-full disabled:opacity-30 disabled:hover:bg-slate-100 font-bold transition-colors"> </button>
